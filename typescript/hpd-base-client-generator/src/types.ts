...
export interface SubjectLifecycleConsumerDescriptor { readonly id: string; readonly version: number; readonly checksum: string; readonly generatedName: string; readonly audience: "service" | "system"; readonly contractId: string; readonly contractVersion: number; readonly observedStates: readonly ("active" | "inactive" | "tombstoned" | "retired")[]; readonly readRoute: string; readonly checkpointRoute: string; readonly reconciliationRoute?: string | null; readonly maximumFactsPerPage: number; readonly maximumResultBytes: number; }
