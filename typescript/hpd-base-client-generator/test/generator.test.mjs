  ...
  const base = {
    ...
    schema: {
      ...
      types: [
        ...
        { id: "collection.documents.record", node: { kind: "object", additionalProperties: false, properties: [{ name: "storedTitle", wireName: "stored_title", typeId: "field.documents.title", required: true, nullable: false, redactionOptional: false }, { name: "embedding", wireName: "embedding", typeId: "field.documents.embedding", required: true, nullable: false, redactionOptional: false }]  } },
        { id: "collection.documents.create", node: { kind: "object", additionalProperties: false, properties: [{ name: "storedTitle", wireName: "stored_title", typeId: "field.documents.title", required: true, nullable: false, redactionOptional: false }, { name: "embedding", wireName: "embedding", typeId: "field.documents.embedding", required: true, nullable: false, redactionOptional: false }]  } },
        { id: "collection.documents.replace", node: { kind: "object", additionalProperties: false, properties: [{ name: "storedTitle", wireName: "stored_title", typeId: "field.documents.title", required: true, nullable: false, redactionOptional: false }, { name: "embedding", wireName: "embedding", typeId: "field.documents.embedding", required: true, nullable: false, redactionOptional: false }]  } },
        { id: "collection.documents.patch", node: { kind: "object", additionalProperties: false, properties: [{ name: "storedTitle", wireName: "stored_title", typeId: "field.documents.title", required: false, nullable: false, redactionOptional: false }, { name: "embedding", wireName: "embedding", typeId: "field.documents.embedding", required: false, nullable: false, redactionOptional: false }] } },
...
test("type graph validation fails closed on malformed kinds, bounds, uniqueness, and union discriminators", () => {
  ...
  assert.throws(() => validate(snapshot([{ id: "tag", node: { kind: "literal", value: "a" } }, { id: "variant", node: { kind: "object", additionalProperties: false, properties: [{ name: "wrong", wireName: "wrong", typeId: "tag", required: true, nullable: false, redactionOptional: false }] } }, { id: "union", node: { kind: "union", discriminator: "kind", variants: [{ tag: "a", typeId: "variant" }, { tag: "b", typeId: "variant" }] } }])), /typeInvalid/);
  assert.throws(() => validate(snapshot([{ id: "x", node: { kind: "object", additionalProperties: false, properties: [{ name: "a", wireName: "a", typeId: "x", required: true, nullable: false, redactionOptional: false }, { name: "a", wireName: "a", typeId: "x", required: true, nullable: false, redactionOptional: false }] } }])), /typeInvalid/);
});
