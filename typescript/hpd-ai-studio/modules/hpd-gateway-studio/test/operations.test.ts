...
describe('Gateway operations controller',()=>{
 ...
 it('applies collection maxima, exact omitted counts, deterministic output, and malformed-Unicode rejection',()=>{
   ...
   expect(value.observations.effective.value.admissionPlans).toHaveLength(512);
   ...
   expect(value.truncation).toMatchObject({effectiveRecordsOmittedLocally:88,appliedUpstreamsOmittedLocally:88,admissionPlansOmittedLocally:88,activationIntentsOmittedLocally:44,activationOutcomesOmittedLocally:44,activationIntentsMayHaveMoreAtSource:true,activationOutcomesMayHaveMoreAtSource:true});
