...
public class LayeredSuspensionTests
{
    ...
    private static HPD.Graph.Abstractions.Graph.Graph CreateSuspendingGraph()
    {
    ...
    private static HPD.Graph.Abstractions.Graph.Graph CreateSuspendingGraphWithOptions(SuspensionOptions options)
    {
        return new TestGraphBuilder()
            .AddStartNode()
...
public sealed class NoopSubscription : IDisposable
{
    public void Dispose() { }
}
