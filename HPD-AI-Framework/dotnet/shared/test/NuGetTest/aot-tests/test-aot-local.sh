...
test_package "HPD-Agent.ToolHarness.FileSystem" "HPD-Agent.ToolHarness/HPD-Agent.ToolHarness.FileSystem/HPD-Agent.ToolHarness.FileSystem.csproj"
test_package "HPD-Agent.ToolHarness.WebSearch" "HPD-Agent.ToolHarness/HPD-Agent.ToolHarness.WebSearch/HPD-Agent.ToolHarness.WebSearch.csproj"
