...
test_package "HPD-Agent.Harness.FileSystem" "HPD-Agent.Harness/HPD-Agent.Harness.FileSystem/HPD-Agent.Harness.FileSystem.csproj"
test_package "HPD-Agent.Harness.WebSearch" "HPD-Agent.Harness/HPD-Agent.Harness.WebSearch/HPD-Agent.Harness.WebSearch.csproj"
