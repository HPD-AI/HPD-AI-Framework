...
namespace HPDGraph.Tests.V21.GeneratedConnectors;
...
public sealed class GeneratedConnectorBehaviorTests
{
    ...
    public void GeneratedDescriptorCatalog_IncludesConfigsActionsAndFields()
    {
        ...
        var descriptor = provider.GetRequiredService<HPDAgent.Graph.Connectors.Abstractions.Descriptors.ConnectorPackageDescriptor>();
