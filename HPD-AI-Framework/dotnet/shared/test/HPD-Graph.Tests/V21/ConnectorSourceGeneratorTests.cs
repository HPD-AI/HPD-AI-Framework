...
using HPDAgent.Graph.Connectors.Abstractions.Attributes;
...
using HPDAgent.Graph.Connectors.SourceGenerator;
...
public sealed class ConnectorSourceGeneratorTests
{
    ...
    public void Generator_EmitsCompilableConnectorSurface()
    {
        ...
        generated.Should().Contain(text => text.Contains("HandleWebhookAsync(HPDAgent.Graph.Connectors.Abstractions.Sources.WebhookEnvelope envelope, System.IServiceProvider services", StringComparison.Ordinal));
