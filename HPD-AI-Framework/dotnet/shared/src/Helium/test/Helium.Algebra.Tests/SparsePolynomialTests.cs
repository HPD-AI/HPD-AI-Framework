...
public class SparsePolynomialTests
{
    // --- Construction ---
    ...
    {
        var p = SparsePolynomial<Integer>.Zero;
    ...
    {
        var p = SparsePolynomial<Integer>.One;
    ...
    {
        var p = SparsePolynomial<Integer>.Monomial(3, (Integer)7);
    ...
    public void XAndC()
    {
        ...
        var c = SparsePolynomial<Integer>.C((Integer)5);
    ...
    public void AdditiveIdentity()
    {
        ...
        Assert.Equal(p, p + SparsePolynomial<Integer>.Zero);
    }
    ...
    {
        var p = SparsePolynomial<Integer>.FromCoeffs((Integer)1, (Integer)2, (Integer)3);
        Assert.Equal(p, p * SparsePolynomial<Integer>.One);
    }
    ...
    {
        var p = SparsePolynomial<Integer>.FromCoeffs((Integer)1, (Integer)2, (Integer)3);
        Assert.Equal(SparsePolynomial<Integer>.Zero, p + (-p));
    }

    [Fact]
    public void Commutativity()
    {
        var p = SparsePolynomial<Integer>.FromCoeffs((Integer)1, (Integer)2);
        var q = SparsePolynomial<Integer>.FromCoeffs((Integer)3, (Integer)4);
    ...
    {
        var a = SparsePolynomial<Integer>.FromCoeffs((Integer)1, (Integer)2);
        var b = SparsePolynomial<Integer>.FromCoeffs((Integer)3, (Integer)4);
        var c = SparsePolynomial<Integer>.FromCoeffs((Integer)5, (Integer)6);
    ...
    {
        // (1 + x) + (2 + 3x) == 3 + 4x
        var p = SparsePolynomial<Integer>.FromCoeffs((Integer)1, (Integer)1);
        var q = SparsePolynomial<Integer>.FromCoeffs((Integer)2, (Integer)3);
        var sum = p + q;
    ...
    {
        // (1 + x) * (1 - x) == 1 - x^2
        var onePlusX = SparsePolynomial<Integer>.FromCoeffs((Integer)1, (Integer)1);
        var oneMinusX = SparsePolynomial<Integer>.FromCoeffs((Integer)1, (Integer)(-1));
    ...
    {
        // (x + 1)^2 == x^2 + 2x + 1
        var xPlusOne = SparsePolynomial<Integer>.FromCoeffs((Integer)1, (Integer)1);
    ...
    {
        var p = SparsePolynomial<Integer>.FromCoeffs((Integer)1, (Integer)0, (Integer)3);
    ...
    {
        var p = SparsePolynomial<Integer>.FromCoeffs((Integer)1, (Integer)0, (Integer)0, (Integer)5);
        Assert.Equal(3, p.Degree);
    ...
    {
        var p = SparsePolynomial<Integer>.FromCoeffs((Integer)1, (Integer)1); // degree 1
        var q = SparsePolynomial<Integer>.FromCoeffs((Integer)1, (Integer)0, (Integer)1); // degree 2
    ...
    public void DivisionExact()
    {
        ...
        var dividend = SparsePolynomial<Rational>.FromCoeffs((Rational)(-1), Rational.Zero, Rational.One);
        var divisor = SparsePolynomial<Rational>.FromCoeffs((Rational)(-1), Rational.One);
    ...
    public void DivisionWithRemainder()
    {
        ...
        var dividend = SparsePolynomial<Rational>.FromCoeffs(Rational.One, Rational.Zero, Rational.One);
        var divisor = SparsePolynomial<Rational>.FromCoeffs(Rational.One, Rational.One);
        var (q, r) = dividend.DivMod(divisor);
    ...
    public void DivisionByZero()
    {
        ...
        var (q, r) = p.DivMod(SparsePolynomial<Rational>.Zero);
    ...
    public void GcdOfCoprime()
    {
        ...
        var a = SparsePolynomial<Rational>.FromCoeffs(Rational.One, Rational.One);
        var b = SparsePolynomial<Rational>.FromCoeffs((Rational)2, Rational.One);
        var g = a.Gcd(b);
    ...
    public void GcdCommonFactor()
    {
        ...
        var xm1 = SparsePolynomial<Rational>.FromCoeffs((Rational)(-1), Rational.One);
        var xm2 = SparsePolynomial<Rational>.FromCoeffs((Rational)(-2), Rational.One);
        var xm3 = SparsePolynomial<Rational>.FromCoeffs((Rational)(-3), Rational.One);
        var a = xm1 * xm2;
        var b = xm2 * xm3;
        var g = a.Gcd(b);
    ...
    {
        var a = SparsePolynomial<Integer>.FromCoeffs((Integer)1, (Integer)2, (Integer)3);
        var b = SparsePolynomial<Integer>.FromCoeffs((Integer)1, (Integer)2, (Integer)3);
        Assert.Equal(a, b);
    }
    ...
    {
        // x^1000 + 1
        var p = SparsePolynomial<Integer>.Monomial(1000, Integer.One) + SparsePolynomial<Integer>.One;
    ...
    public void ConvolutionCancellationYieldsExactZero()
    {
        ...
        var p = SparsePolynomial<Integer>.FromCoeffs((Integer)1, (Integer)1);
        var q = SparsePolynomial<Integer>.FromCoeffs((Integer)1, (Integer)(-1));
        var r = p * q;
    ...
    public void ConvolutionDegreeAdds()
    {
        ...
        var p = SparsePolynomial<Integer>.FromCoeffs((Integer)1, (Integer)2, (Integer)3); // deg 2
        var q = SparsePolynomial<Integer>.FromCoeffs((Integer)4, (Integer)5, (Integer)6); // deg 2
        var r = p * q;
    ...
    public void ConvolutionLargeSparsePoly()
    {
        ...
        var a = SparsePolynomial<Integer>.Monomial(500, Integer.One) + SparsePolynomial<Integer>.One;
        var b = SparsePolynomial<Integer>.Monomial(500, Integer.One) - SparsePolynomial<Integer>.One;
        var r = a * b;
