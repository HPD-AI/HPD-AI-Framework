...
public class ZModElementTests
{
    private static ZModElement Mod5(Integer value) => ZMod.Create(value, (Integer)5);
    ...
    public void ZMod5_AdditionWraps()
    {
        ...
        var sum = a + b;
        Assert.Equal((Integer)2, sum.Value); // 3 + 4 = 7 ≡ 2 mod 5
    }
    ...
    public void ZMod5_Multiplication()
    {
        ...
        var b = Mod5((Integer)4);
        var product = a * b;
        Assert.Equal((Integer)2, product.Value); // 3 * 4 = 12 ≡ 2 mod 5
    }
    ...
    public void ZMod5_Negation()
    {
        var a = Mod5((Integer)3);
        var neg = -a;
        Assert.Equal((Integer)2, neg.Value); // -3 ≡ 2 mod 5
    }
    ...
    {
        var a = Mod5((Integer)3);
        Assert.Equal((Integer)0, (a + (-a)).Value);
    }
    ...
    public void ZMod5_Reduction()
    {
        ...
        Assert.Equal((Integer)3, a.Value); // 13 ≡ 3 mod 5
    }
    ...
    {
        var a = Mod5((Integer)(-3));
        Assert.Equal((Integer)2, a.Value); // -3 ≡ 2 mod 5
    }
    ...
    public void ZMod1_EverythingIsZero()
    {
        ...
        Assert.Equal((Integer)0, a.Value);
    }
    ...
    public void SameContext_Allowed()
    {
        ...
        Assert.Equal((Integer)2, sum.Value);
    }
    ...
    public void SentinelPlusReal_Allowed()
    {
        ...
        var zero = ZModElement.AdditiveIdentity;
        var a = ZMod.Create((Integer)3, (Integer)5);
        var sum = zero + a; // must not throw
        Assert.Equal((Integer)3, sum.Value);
    }
