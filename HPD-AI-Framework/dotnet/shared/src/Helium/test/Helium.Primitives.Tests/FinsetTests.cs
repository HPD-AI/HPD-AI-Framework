...
public class FinsetTests
{
    ...
    {
        var s = Finset<Integer>.FromElements([1, 2, 1, 3]);
    ...
    public void Union()
    {
        var a = Finset<Integer>.Of(1, 2);
        var b = Finset<Integer>.Of(2, 3);
        var u = a.Union(b);
    ...
    public void Inter()
    {
        var a = Finset<Integer>.Of(1, 2, 3);
        var b = Finset<Integer>.Of(2, 3, 4);
        var i = a.Inter(b);
    ...
    public void SetIdentities()
    {
        ...
        Assert.Equal(Finset<Integer>.Empty, a.SDiff(a));
        Assert.Equal(a, a.Union(Finset<Integer>.Empty));
        Assert.Equal(Finset<Integer>.Empty, a.Inter(Finset<Integer>.Empty));
    }
    ...
    public void PowersetOfTwoElements()
    {
        ...
        Assert.Contains(Finset<Integer>.Empty, ps);
        Assert.Contains(Finset<Integer>.Of(1), ps);
        Assert.Contains(Finset<Integer>.Of(2), ps);
        Assert.Contains(Finset<Integer>.Of(1, 2), ps);
    }
    ...
    {
        var s = Finset<Integer>.Of(1, 2, 3, 4);
    ...
    {
        var s = Finset<Integer>.Of(1, 2, 3, 4, 5);
    ...
    {
        var a = Finset<Integer>.Of(3, 1, 2);
        var b = Finset<Integer>.Of(1, 2, 3);
        Assert.Equal(a, b);
    }
    ...
    {
        var a = Finset<Integer>.Of(1, 2);
        var b = Finset<Integer>.Of(1, 3);
        Assert.NotEqual(a, b);
    }

    [Fact]
    public void FinsetsHaveLexicographicTotalOrder()
    {
        var empty = Finset<Integer>.Empty;
        var one = Finset<Integer>.Of(1);
        var oneTwo = Finset<Integer>.Of(1, 2);
        var oneThree = Finset<Integer>.Of(1, 3);

        Assert.True(Finset<Integer>.DecidableEquals(oneTwo, Finset<Integer>.Of(2, 1)));
        Assert.Equal(Ordering.Less, Finset<Integer>.CompareOrder(empty, one));
        Assert.Equal(Ordering.Less, Finset<Integer>.CompareOrder(one, oneTwo));
        Assert.Equal(Ordering.Less, Finset<Integer>.CompareOrder(oneTwo, oneThree));
        Assert.True(Finset<Integer>.LessEqual(oneTwo, oneThree));
        Assert.False(Finset<Integer>.LessEqual(oneThree, oneTwo));
    }
}
