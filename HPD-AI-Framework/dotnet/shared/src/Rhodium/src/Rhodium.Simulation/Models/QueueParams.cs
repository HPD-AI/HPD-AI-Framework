...
public sealed record QueueParams
{
    ...
    public decimal? InitialPositionOverride { get; init; }
    public decimal? AdvancementPerUnitOverride { get; init; }
    ...
    public static QueueParams Tail() => RiskAverse();

    public static QueueParams DeterministicTail(
        decimal initialPosition = 1m,
        decimal advancementPerUnit = 1m) => new()
    {
        Model = QueueModelType.RiskAverse,
        InitialPositionOverride = initialPosition,
        AdvancementPerUnitOverride = advancementPerUnit
    };
