...
/// All tests use <see cref="SlackBotJsonContext.Default.Options"/> to verify
/// the AOT-safe code path — the same context used by <see cref="SlackBot.HandleSocketEnvelopeAsync"/>.
/// </summary>
public class SlackSocketEnvelopeTests
{
    private static T Deserialize<T>(string json) =>
        JsonSerializer.Deserialize<T>(json, SlackBotJsonContext.Default.Options)!;
