...
/// Includes all core types plus FFI-specific types like RustFunctionInfo, HarnessRegistry, etc.
/// </summary>
...
[JsonSerializable(typeof(PreserveBranchHistoryOptions))]
[JsonSerializable(typeof(CompactBranchHistoryOptions))]
