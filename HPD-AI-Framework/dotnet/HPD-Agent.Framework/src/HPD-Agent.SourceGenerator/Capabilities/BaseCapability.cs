...
internal abstract class BaseCapability : ICapability
{
    ...
    /// <summary>
    /// The namespace of the parent ToolHarness class.
    /// </summary>
    public string ParentNamespace { get; set; } = string.Empty;

    /// <summary>
    /// The name of the parent ToolHarness class.
    /// </summary>
    public string ParentToolHarnessName { get; set; } = string.Empty;
    ...
    public string FullName => string.IsNullOrEmpty(ParentNamespace)
        ? $"{ParentToolHarnessName}.{Name}"
        : $"{ParentNamespace}.{ParentToolHarnessName}.{Name}";
}
