...
internal abstract class BaseCapability : ICapability
{
    ...
    /// <summary>
    /// The namespace of the parent Harness class.
    /// </summary>
    public string ParentNamespace { get; set; } = string.Empty;

    /// <summary>
    /// The name of the parent Harness class.
    /// </summary>
    public string ParentHarnessName { get; set; } = string.Empty;
    ...
    public string FullName => string.IsNullOrEmpty(ParentNamespace)
        ? $"{ParentHarnessName}.{Name}"
        : $"{ParentNamespace}.{ParentHarnessName}.{Name}";
}
