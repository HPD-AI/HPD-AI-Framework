...
/// <summary>
/// Marks a method as the handler for a specific bot event type.
...
/// the public adapter dispatch entry point that calls this method.
/// </remarks>
...
public sealed class HpdBotEventHandlerAttribute(string eventType) : Attribute
{
