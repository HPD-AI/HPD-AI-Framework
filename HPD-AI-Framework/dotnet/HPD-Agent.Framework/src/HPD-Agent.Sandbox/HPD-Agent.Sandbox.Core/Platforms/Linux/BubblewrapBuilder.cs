...
public sealed class BubblewrapBuilder
{
    ...
    public PreparedSandboxCommand BuildCommand(string command, string shell = "/bin/sh")
    {
        ...
        return new PreparedSandboxCommand("bwrap", args);
    }
    ...
    /// </summary>
    public PreparedSandboxCommand BuildWithSetupCommand(string setupScript, string command, string shell = "/bin/sh")
    {
    ...
    /// </summary>
    public PreparedSandboxCommand BuildWithSeccompCommand(string setupScript, string command, string seccompHelperPath, string shell = "/bin/sh")
    {
    ...
    private static string Render(PreparedSandboxCommand command)
    {
