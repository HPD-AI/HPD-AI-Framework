...
/// </remarks>
public sealed class LocalProcessIsolationManager : IAsyncDisposable
{
    private readonly ILogger? _logger;
    private readonly SemaphoreSlim _initLock = new(1, 1);
    private ILocalProcessIsolationBackend? _platformBackend;
    ...
    public LocalProcessIsolationManager(ILogger? logger = null)
    {
        _logger = logger;
    }
    ...
    internal async Task<PreparedLocalProcessCommand> WrapCommandAsync(
    ...
    private void StartPlatformViolationDrain(ILocalProcessIsolationBackend platformBackend)
    {
