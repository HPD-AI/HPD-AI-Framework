...
public class OpenAIProviderTests
{
    ...
    public void Provider_ShouldHaveCorrectMetadata()
    {
        ...
        metadata.DocumentationUri.Should().Be(new Uri("https://platform.openai.com/docs"));
        var chat = metadata.Families[ProviderClientFamily.Chat];
        chat.Capabilities.Should().NotBeNull();
        ...
        metadata.Families[ProviderClientFamily.HostedFiles].Capabilities!["SupportsContainerFiles"].Should().Be(true);
    ...
    public void WithOpenAI_ShouldConfigureProvider()
    {
        ...
        builder.Config.EnsureChatClientConfig().ModelName.Should().Be("gpt-4o");
        builder.Config.EnsureChatClientConfig().ApiKey.Should().Be("sk-test123");

        var typedConfig = builder.Config.EnsureChatClientConfig().GetProviderConfig<OpenAIProviderConfig>();
    ...
    public void WithAzureOpenAI_ShouldConfigureProvider()
    {
        ...
        builder.Config.EnsureChatClientConfig().ApiKey.Should().Be("test-key");
