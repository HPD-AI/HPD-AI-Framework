...
/// <summary>
/// Branch tree delete operation tests.
/// Tests for safe deletion with referential integrity and sibling reindexing.
/// </summary>
public class BranchTreeDeleteTests : AgentTestBase
{
    //──────────────────────────────────────────────────────────────────
    ...
    public async Task Test17_DeleteBranch_ReindexesRemainingSiblings()
    {
        ...
        var beforeMain = await repository.LoadBranchAsync("test-session", "main");
        var beforeFork1 = await repository.LoadBranchAsync("test-session", "fork-1");
        var beforeFork2 = await repository.LoadBranchAsync("test-session", "fork-2");
        var beforeFork3 = await repository.LoadBranchAsync("test-session", "fork-3");
        ...
        var afterMain = await repository.LoadBranchAsync("test-session", "main");
        var afterFork1 = await repository.LoadBranchAsync("test-session", "fork-1");
        var afterFork2 = await repository.LoadBranchAsync("test-session", "fork-2");
        var afterFork3 = await repository.LoadBranchAsync("test-session", "fork-3");
    ...
    public async Task Test34_ForkMultipleBranches_VerifySiblingOrder()
    {
        ...
        for (int i = 0; i < 5; i++)
        {
            var reloaded = await repository.LoadBranchAsync("test-session", $"fork-{i}");
    ...
    public async Task Test35_DeleteBranch_VerifySiblingsReindexed()
    {
        ...
        Assert.Null(await repository.LoadBranchAsync("test-session", "fork-2"));

        var reloadedMain = await repository.LoadBranchAsync("test-session", "main");
        var fork0 = await repository.LoadBranchAsync("test-session", "fork-0");
        var fork1 = await repository.LoadBranchAsync("test-session", "fork-1");
        var fork3 = await repository.LoadBranchAsync("test-session", "fork-3");
        var fork4 = await repository.LoadBranchAsync("test-session", "fork-4");
    ...
    public async Task D4_DeleteAllForks_SourceIsAlone()
    {
        ...
        var finalMain = await repository.LoadBranchAsync("test-session", "main");
    ...
    private async Task<HPD.Agent.Agent> CreateAgentWithStore(ISessionRepository repository)
    {
