...
/// <summary>
/// Critical middleware state serialization round-trip tests.
...
public class MiddlewareStateSerializationTests
{
    ...
    public async Task CriticalPath_StateRoundTrip_PreservesAllMiddlewareState()
    {
        ...
        var runtimeState = AgentLoopState.InitialSafe(
            ...
            runId: "state-roundtrip-test-run",
            conversationId: "state-roundtrip-test-conv",
            agentName: "StateRoundTripAgent")
            with
            {
        ...
        //      
        // PHASE 2: SERIALIZE - Create durable JSON
        //      
        ...
        //      
        // PHASE 3: DESERIALIZE - Restore from durable JSON
        //      
    ...
    /// <summary>
    /// Edge case: Empty middleware state serializes and deserializes correctly.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// Complex scenario: Multiple state updates through serialization cycles.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// Integration test: Real middleware workflow with serialized state restore.
    /// </summary>
    [Fact]
    public async Task RealMiddlewareWorkflow_WithSerializedState_WorksCorrectly()
    {
        ...
        // Serialize state.
        var stateJson = JsonSerializer.Serialize(initialState, AIJsonUtilities.DefaultOptions);

        // Simulate state restore.

        var resumedState = JsonSerializer.Deserialize<AgentLoopState>(stateJson, AIJsonUtilities.DefaultOptions)!;
