...
public sealed class FunctionRuntimeContextSourceGeneratorTests
{
    ...
    private static string FindRepoRoot()
    {
        ...
        {
            if (System.IO.Directory.Exists(System.IO.Path.Combine(directory.FullName, "HPD-AI-Framework")))
            {
...
""";
        ...
        Assert.Contains("\\\"query\\\"", generatedCode);
...
""";
        ...
        Assert.Contains("SchemaProvider = () =>", generatedCode);
        Assert.Contains("\\\"properties\\\":{}", generatedCode);
    }
...
""";
    ...
    public void SubAgentWrapperGenerator_UsesExplicitFunctionExecutionContext()
    {
        var source = System.IO.File.ReadAllText(System.IO.Path.Combine(
            FindRepoRoot(),
            "HPD-AI-Framework/dotnet/HPD-Agent.Framework/src/HPD-Agent.SourceGenerator/Capabilities/SubAgentCapability.cs"));
    ...
    public void MultiAgentWrapperGenerator_UsesExplicitFunctionExecutionContext()
    {
        var source = System.IO.File.ReadAllText(System.IO.Path.Combine(
            FindRepoRoot(),
            "HPD-AI-Framework/dotnet/HPD-Agent.Framework/src/HPD-Agent.SourceGenerator/Capabilities/MultiAgentCapability.cs"));
...
""";
    ...
    public void StaticGuard_RuntimeParamFilterCentralized()
    {
        var sourceGeneratorRoot = System.IO.Path.Combine(
            FindRepoRoot(),
            "HPD-AI-Framework/dotnet/HPD-Agent.Framework/src/HPD-Agent.SourceGenerator");
