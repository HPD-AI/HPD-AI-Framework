...
public sealed class EvaluationMiddlewareConversationStateTests
{
    [Fact]
    public void AdvanceConversationEvalState_FirstTurn_SetsGoalAndStoresResponse()
    {
        ...
        var next = EvaluationMiddleware.AdvanceConversationEvalState(
    ...
    public void AdvanceConversationEvalState_ExistingGoal_PreservesGoalAndAppendsResponse()
    {
        ...
        var next = EvaluationMiddleware.AdvanceConversationEvalState(state, turnCtx);
    ...
    public void BuildConversationHistoryForEvaluation_MergesBranchHistoryAndStoredResponses()
    {
        ...
        var history = EvaluationMiddleware.BuildConversationHistoryForEvaluation(turnCtx, state);
