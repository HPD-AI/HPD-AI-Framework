...
public sealed class BidirectionalInteractionTests
{
    [Fact]
    public void AddInteractionHandler_RegistersBidirectionalInteractionHandlers()
    {
    ...
    [Fact]
    public void AddAgentTuiDefaults_DoesNotRegisterBidirectionalInteractionHandlers()
    {
        var registry = new HpdAgentTuiBuilder()
            .AddAgentTuiDefaults()
            .Build();
