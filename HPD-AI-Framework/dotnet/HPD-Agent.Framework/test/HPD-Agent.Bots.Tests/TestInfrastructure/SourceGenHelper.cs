...
using HPD.Agent.Bots.SourceGenerator;
...
/// <summary>
/// Helpers for running BotSourceGenerator in tests via CSharpGeneratorDriver.
/// </summary>
internal static class SourceGenHelper
{
    ...
    private static MetadataReference[] BuildBaseReferences()
    {
        ...
        var aspNetCoreBots = MetadataReference.CreateFromFile(typeof(BotRegistration).Assembly.Location);
    ...
    /// <summary>
    /// Runs BotSourceGenerator against the given source and returns the driver run result.
    /// </summary>
        ...
        string assemblyName = "TestAssembly")
    {
        ...
        var generator   = new BotSourceGenerator();
