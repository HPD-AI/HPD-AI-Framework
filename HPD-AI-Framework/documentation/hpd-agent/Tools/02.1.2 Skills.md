...
## Skills vs Collapsed Harneses

Both skills and collapsed harnesses group functions, but they serve different purposes:

| Aspect | Skill | Collapsed Harness |
|--------|-------|------------------|
...
| **Scope** | Can reference functions across harnesses | Single harness only |
...
**Use `[Harness("description")]` when:** You just want to reduce the number of visible tools.
