...
## Skills vs Collapsed ToolHarnesses

Both skills and collapsed toolharnesses group functions, but they serve different purposes:

| Aspect | Skill | Collapsed ToolHarness |
|--------|-------|------------------|
...
| **Scope** | Can reference functions across toolharnesses | Single toolharness only |
...
**Use `[ToolHarness("description")]` when:** You just want to reduce the number of visible tools.
