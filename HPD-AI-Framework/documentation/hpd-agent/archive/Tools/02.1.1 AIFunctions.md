...
When a harness has multiple functions, you can group them under a collapsible container using `[Collapse("description")]`:
...
**Note:** Providing a description to `[Collapse]` enables collapsing. Without `[Collapse]`, the harness's functions are always visible.
