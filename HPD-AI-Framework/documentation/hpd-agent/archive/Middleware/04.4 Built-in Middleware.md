...
Scopes middleware to specific ToolHarnesses/skills.
...
- `context.ToolHarnessName` matches `ToolHarnessName`, OR
- `context.SkillName` matches `SkillName`

Use for ToolHarness/skill-specific behavior.
