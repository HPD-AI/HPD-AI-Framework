...
| `ClientToolHarnessesRegisteredEvent` | Client registered its tool groups |
...
| `COMPACTION_CACHE` | `CompactionCacheEvent` | History reduction metrics |
...
| `ITERATION_CONTEXT_SNAPSHOT` | `IterationContextSnapshotEvent` | Non-history context sent to model |
