      ...
      '/hpd-agent/': [
        ...
        },
        {
          ...
          items: [
            ...
            { text: 'As a ToolHarness Capability', link: '/hpd-agent/Multi-Agent/06.5 As a ToolHarness Capability' },
        ...
        },
        {
          ...
          items: [
            ...
            { text: 'Building a ToolHarness', link: '/hpd-agent/Cookbook/02 Building a ToolHarness' },
