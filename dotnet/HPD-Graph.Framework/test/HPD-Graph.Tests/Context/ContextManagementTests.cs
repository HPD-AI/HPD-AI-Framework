...
public class ContextManagementTests
{
    ...
    public void GraphContext_Logging_ShouldCaptureEntries()
    {
        ...
        // Act
        context.Log("Component1", "Message 1", HPD.Graph.Abstractions.Context.LogLevel.Information);
        context.Log("Component2", "Message 2", HPD.Graph.Abstractions.Context.LogLevel.Debug);
        context.Log("Component3", "Message 3", HPD.Graph.Abstractions.Context.LogLevel.Warning);
