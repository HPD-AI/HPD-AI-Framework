...
public class MapNodeExecutionTests
{
    ...
    public void Validate_MapNodeWithoutProcessorGraph_ReturnsError()
    {
        ...
        var graph = new HPD.Graph.Abstractions.Graph.Graph
        {
            Id = "test",
            Name = "Test",
            Version = "1.0",
    ...
    public void Validate_MapNodeWithInvalidProcessorGraph_ReturnsError()
    {
        ...
        var invalidProcessorGraph = new HPD.Graph.Abstractions.Graph.Graph
        {
            Id = "processor",
            Name = "Processor",
            Version = "1.0",
    ...
    public async Task ExecuteAsync_HeterogeneousMap_RoutesItemsToCorrectProcessorGraphs()
    {
        ...
        var graph = new TestGraphBuilder()
            ...
            .AddMapNode("map", mapProcessorGraphs: new Dictionary<string, HPD.Graph.Abstractions.Graph.Graph>
            {
                ["string"] = stringGraph,
                ["int"] = intGraph
    ...
    public async Task ExecuteAsync_HeterogeneousMap_FallbackToDefaultGraph()
    {
        ...
        var graph = new TestGraphBuilder()
            ...
            .AddHandlerNode("prepare", "MixedTypeListProducerHandler") // Returns ["hello", 42, "world"]
            .AddMapNode("map",
                mapProcessorGraphs: new Dictionary<string, HPD.Graph.Abstractions.Graph.Graph>
                {
                    ["string"] = stringGraph
