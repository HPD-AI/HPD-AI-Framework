...
public class TestGraphBuilder
{
    ...
    public TestGraphBuilder AddHandlerNode(
        ...
        HPD.Graph.Abstractions.Execution.SuspensionOptions? suspensionOptions = null)
    {
        _nodes.Add(new Node
        {
            Id = id,
    ...
    public TestGraphBuilder AddSubGraphNode(
        string id,
        HPD.Graph.Abstractions.Graph.Graph subGraph,
        string? name = null)
    {
        _nodes.Add(new Node
        {
    ...
    public TestGraphBuilder AddMapNode(
        string id,
        HPD.Graph.Abstractions.Graph.Graph processorGraph,
        string? name = null,
    ...
    public TestGraphBuilder AddMapNode(
        string id,
        IReadOnlyDictionary<string, HPD.Graph.Abstractions.Graph.Graph>? mapProcessorGraphs = null,
        string? mapRouterName = null,
        HPD.Graph.Abstractions.Graph.Graph? mapDefaultGraph = null,
        string? name = null,
        int? maxParallelMapTasks = null,
        MapErrorMode? errorMode = null,
        string? mapInputChannel = null,
    ...
    public HPD.Graph.Abstractions.Graph.Graph Build()
    {
        return new HPD.Graph.Abstractions.Graph.Graph
        {
            Id = _id,
            Name = _name,
            Version = _version,
