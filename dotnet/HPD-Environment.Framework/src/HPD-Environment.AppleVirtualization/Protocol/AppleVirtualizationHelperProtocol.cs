namespace HPD.Environment.AppleVirtualization.Protocol;
...
{
    public string ClientName { get; init; } = "HPD-Environment.AppleVirtualization";
...
public sealed record AppleVirtualizationProcessStartRequest
{
    ...
    public SandboxPlanEnvelope? SandboxPlan { get; init; }
