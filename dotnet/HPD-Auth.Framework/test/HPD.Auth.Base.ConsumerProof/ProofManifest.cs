...
internal static class ProofManifest
{
    ...
    [
        ...
        new("l76-durable-yield", "L76 same-activation durable yield beyond lineage depth", "ProofActivation.cs:135", "proof.yield.v1@1", Convert.ToHexStringLower(ProofYieldActivation.Registration.Identity.Checksum.Span), "BaseActivationYielded<ProofActivationResult>"),
