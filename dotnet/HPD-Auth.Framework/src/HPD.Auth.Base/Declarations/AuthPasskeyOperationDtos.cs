...
internal sealed record AuthPasskeyRegisterV1
{
    ...
    [BaseField("auth.operation.passkey.register.expectedUserGeneration")] public required BaseModuleGeneration ExpectedUserGeneration { get; init; }
    [BaseField("auth.operation.passkey.register.expectedSecurityGeneration")] public required BaseModuleGeneration ExpectedSecurityGeneration { get; init; }
...
internal sealed record AuthPasskeyRecordAssertionV1
{
    ...
    [BaseField("auth.operation.passkey.assert.expectedSecurityGeneration")] public required BaseModuleGeneration ExpectedSecurityGeneration { get; init; }
