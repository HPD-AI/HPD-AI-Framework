...
internal sealed record AuthRefreshIssueV1
{
    ...
    [BaseField("auth.operation.refresh.issue.protectionAssociatedData", MaximumBytes = 4096)] public required BaseBinary ProtectionAssociatedData { get; init; }
    ...
    [BaseField("auth.operation.refresh.issue.requestFingerprint", MaximumBytes = 32)] public required BaseBinary RequestFingerprint { get; init; }
    [BaseField("auth.operation.refresh.issue.retentionEligibleAt"), JsonConverter(typeof(BaseUtcDateTimeJsonConverter))] public required DateTimeOffset RetentionEligibleAt { get; init; }
...
internal sealed record AuthRefreshRotateV1
{
    ...
    [BaseField("auth.operation.refresh.rotate.protectionAssociatedData", MaximumBytes = 4096)] public required BaseBinary ProtectionAssociatedData { get; init; }
    ...
    [BaseField("auth.operation.refresh.rotate.requestFingerprint", MaximumBytes = 32)] public required BaseBinary RequestFingerprint { get; init; }
    [BaseField("auth.operation.refresh.rotate.replacementRetentionEligibleAt"), JsonConverter(typeof(BaseUtcDateTimeJsonConverter))] public required DateTimeOffset ReplacementRetentionEligibleAt { get; init; }
