...
internal sealed partial record AuthUserIdentityRecordV1
{
    ...
    [BaseField("auth.userIdentities.provider", MaximumUtf8Bytes = 128, StringNormalization = BaseStringNormalizationRequirement.RequireNfc), BaseFieldConfidentiality(BaseFieldConfidentiality.Internal)] public required string Provider { get; init; }
