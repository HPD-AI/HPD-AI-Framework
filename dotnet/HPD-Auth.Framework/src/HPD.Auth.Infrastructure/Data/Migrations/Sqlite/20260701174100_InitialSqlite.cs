...
namespace HPD.Auth.Infrastructure.Data.Migrations.Sqlite
{
    ...
    public partial class InitialSqlite : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AuditLogs_InstanceId_Action_Timestamp",
                table: "AuditLogs",
                columns: new[] { "InstanceId", "Action", "Timestamp" });

            migrationBuilder.CreateIndex(
                name: "IX_AuditLogs_InstanceId_Category_Timestamp",
                table: "AuditLogs",
                columns: new[] { "InstanceId", "Category", "Timestamp" });

            migrationBuilder.CreateIndex(
                name: "IX_AuditLogs_InstanceId_UserId_Timestamp",
                table: "AuditLogs",
                columns: new[] { "InstanceId", "UserId", "Timestamp" });
