...
public sealed class SelectionController<T>
{
    ...
    public Action<CollectionItem<T>>? Submitted { get; set; }
    ...
    public void Submit()
    {
        ...
        _model.CurrentValue = item.Value;
        _model.Selection.SelectedKey = item.Key;
