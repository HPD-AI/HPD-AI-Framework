...
HPD_AGENT_PROJECTS=(
  ...
  "$ROOT/HPD-Extract.Framework/src/HPD-Extract.Abstractions/HPD-Extract.Abstractions.csproj"
  "$ROOT/HPD-Extract.Framework/src/HPD-Extract.Pdf/HPD-Extract.Pdf.csproj"
  "$ROOT/HPD-Extract.Framework/src/HPD-Extract.Web/HPD-Extract.Web.csproj"
  "$ROOT/HPD-Extract.Framework/src/HPD-Extract.Office/HPD-Extract.Office.csproj"
  "$ROOT/HPD-Extract.Framework/src/HPD-Extract.Images/HPD-Extract.Images.csproj"
  "$ROOT/HPD-Extract.Framework/src/HPD-Extract/HPD-Extract.csproj"
