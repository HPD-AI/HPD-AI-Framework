...
namespace HPD.Base.Auth.HPDAuth.AspNetCore.Tests.Integration;
...
public sealed class AdminEndpointGatingTests
{
    ...
    private static async Task<WebApplication> CreateAppAsync(Action<HPD.Base.AspNetCore.EndpointMapping.HPDBaseEndpointOptions>? configureEndpoints = null)
    {
