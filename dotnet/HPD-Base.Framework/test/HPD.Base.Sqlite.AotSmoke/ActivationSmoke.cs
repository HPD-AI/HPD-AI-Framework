...
internal static class ActivationSmoke
{
    ...
    internal static BaseActivationHandlerRegistration<ActivationSmokeInput, ActivationSmokeResult> Registration { get; } =
        ...
        [BaseModuleDtoPropertyBinding.Create<ActivationSmokeInput, string>("hpd.base.sqlite.aot.activation.input.value", "value")],
        [BaseModuleDtoPropertyBinding.Create<ActivationSmokeResult, string>("hpd.base.sqlite.aot.activation.result.value", "value")],
