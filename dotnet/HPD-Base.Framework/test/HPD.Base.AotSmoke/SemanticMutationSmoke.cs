...
{
    [BaseField("hpd.base.aot.semantic.result.disposition")] public required string Disposition { get; init; }
    [BaseField("hpd.base.aot.semantic.result.activation-id")] public string? ActivationId { get; init; }
...
{
    [BaseField("hpd.base.aot.semantic.result.retirement-disposition")] public required string Disposition { get; init; }
}
