...
{
    internal const string DefinitionId = "hpd.base.aot.semantic.v1";
    internal const string EnsureGrant = "hpd.base.aot.semantic.ensure";
    internal const string RetireGrant = "hpd.base.aot.semantic.retire";
    internal const string MaintainGrant = "hpd.base.aot.semantic.maintain";
    ...
    private static BaseSemanticActivationKeyDefinition CreateDefinition()
    {
        ...
        {
            Id = DefinitionId, Version = 1, OwningApplicationId = "hpd.base.application",
            OwningModuleId = "hpd.base.aot",
            EnsureOperation = new()
            {
            ...
            RequestTypeId = "hpd.base.aot.semantic.request", RequestSerializerChecksum = requestChecksum,
