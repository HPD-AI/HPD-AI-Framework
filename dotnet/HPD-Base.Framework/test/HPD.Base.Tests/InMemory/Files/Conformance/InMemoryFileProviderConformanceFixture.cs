namespace HPD.Base.Tests.InMemory.Files.Conformance;

public sealed class InMemoryFileProviderConformanceFixture : IFileStorageProviderConformanceFixture
{
    private readonly InMemoryFileStorageProvider _provider = new(Options.Create(new HPDBaseInMemoryFileStoreOptions
    {
