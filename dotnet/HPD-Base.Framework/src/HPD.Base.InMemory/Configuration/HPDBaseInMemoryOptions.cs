...
/// </summary>
public sealed class HPDBaseInMemoryOptions
{
    /// <summary>Gets or sets the store id advertised by the store and used for registry binding.</summary>
    public string StoreId { get; set; } = HPDBaseInMemoryDefaults.DefaultStoreId;
    /// <summary>Gets or sets the module id used for descriptor contribution.</summary>
    public string ModuleId { get; set; } = HPDBaseInMemoryDefaults.DefaultModuleId;
    /// <summary>Gets or sets the module display name used for descriptor contribution.</summary>
    public string ModuleName { get; set; } = HPDBaseInMemoryDefaults.DefaultModuleName;
    /// <summary>Gets or sets the store version advertised by the store.</summary>
    public string StoreVersion { get; set; } = HPDBaseInMemoryDefaults.DefaultStoreVersion;
    ...
    public string HealthRefId { get; set; } = HPDBaseInMemoryDefaults.DefaultHealthRefId;
    /// <summary>Gets or sets the diagnostic reference id used by descriptor and diagnostic contribution.</summary>
    public string DiagnosticRefId { get; set; } = HPDBaseInMemoryDefaults.DefaultDiagnosticRefId;
}
