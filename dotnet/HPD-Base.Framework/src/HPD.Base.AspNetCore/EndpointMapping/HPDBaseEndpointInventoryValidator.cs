    ...
    BaseModuleMutationRegistry? moduleMutations = null)
{
    ...
    private static readonly IReadOnlyDictionary<string, Expected> Static = new Dictionary<string, Expected>(StringComparer.Ordinal)
    {
        ...
        ["base.activation.cancel"] = Application("POST", "/activations/cancel", HPDBaseEndpointOperation.ActivationCancel, HPDBaseCapabilities.ActivationCancel),
        ...
        ["base.semanticActivation.inspect"] = Control("POST", "/control/stores/{storeId}/semantic-activations/query", HPDBaseEndpointOperation.SemanticActivationInspect, HPDBaseCapabilities.SemanticActivationInspect),
        ["base.semanticActivation.control.read"] = Control("POST", "/control/stores/{storeId}/semantic-activations/{definitionId}/control", HPDBaseEndpointOperation.SemanticActivationControlRead, HPDBaseCapabilities.SemanticActivationMaintenance),
        ["base.semanticActivation.compact"] = Control("POST", "/control/stores/{storeId}/semantic-activations:compact", HPDBaseEndpointOperation.SemanticActivationCompact, HPDBaseCapabilities.SemanticActivationMaintenance),
        ["base.semanticActivation.maintenance.resume"] = Control("POST", "/control/stores/{storeId}/semantic-activations/maintenance:resume", HPDBaseEndpointOperation.SemanticActivationMaintenanceResume, HPDBaseCapabilities.SemanticActivationMaintenance),
        ["base.semanticActivation.maintenance.resolve"] = Control("POST", "/control/stores/{storeId}/semantic-activations/maintenance:resolve", HPDBaseEndpointOperation.SemanticActivationMaintenanceResolve, HPDBaseCapabilities.SemanticActivationMaintenance),
        ["base.semanticActivation.remove"] = Control("POST", "/control/stores/{storeId}/semantic-activations:remove", HPDBaseEndpointOperation.SemanticActivationRemove, HPDBaseCapabilities.SemanticActivationMaintenance),
        ...
        ["base.activation.claim"] = Application("POST", "/activations/claims/next", HPDBaseEndpointOperation.ActivationClaim, HPDBaseCapabilities.ActivationClaim),
        ["base.activation.renew"] = Application("POST", "/activations/claims/renew", HPDBaseEndpointOperation.ActivationRenew, HPDBaseCapabilities.ActivationRenew),
        ["base.activation.complete"] = Application("POST", "/activations/complete", HPDBaseEndpointOperation.ActivationComplete, HPDBaseCapabilities.ActivationComplete),
        ["base.activation.fail"] = Application("POST", "/activations/fail", HPDBaseEndpointOperation.ActivationFail, HPDBaseCapabilities.ActivationFail),
        ["base.activation.receipt.resolve"] = Application("POST", "/activations/receipts/resolve", HPDBaseEndpointOperation.ActivationReceiptResolve, HPDBaseCapabilities.ActivationReceiptResolve),
        ["base.activation.effect.begin"] = Application("POST", "/activations/effects/begin", HPDBaseEndpointOperation.ActivationEffectBegin, HPDBaseCapabilities.ActivationEffectBegin),
        ["base.activation.effect.heartbeat"] = Application("POST", "/activations/effects/heartbeat", HPDBaseEndpointOperation.ActivationEffectHeartbeat, HPDBaseCapabilities.ActivationEffectHeartbeat),
        ["base.activation.executor.register"] = Application("POST", "/activation-executors/register", HPDBaseEndpointOperation.ActivationExecutorRegister, HPDBaseCapabilities.ActivationExecutorRegister),
        ["base.activation.executor.heartbeat"] = Application("POST", "/activation-executors/heartbeat", HPDBaseEndpointOperation.ActivationExecutorHeartbeat, HPDBaseCapabilities.ActivationExecutorHeartbeat),
        ["base.activation.executor.retire"] = Application("POST", "/activation-executors/retire", HPDBaseEndpointOperation.ActivationExecutorRetire, HPDBaseCapabilities.ActivationExecutorRetire),
