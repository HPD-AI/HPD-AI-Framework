    ...
    BaseModuleMutationRegistry? moduleMutations = null)
{
    ...
    private static readonly IReadOnlyDictionary<string, Expected> Static = new Dictionary<string, Expected>(StringComparer.Ordinal)
    {
        ...
        ["base.semanticActivation.maintenance.execute"] = Control("POST", "/control/semantic-activations/maintenance", HPDBaseEndpointOperation.SemanticActivationMaintenanceExecute, HPDBaseCapabilities.SemanticActivationMaintenance),
        ["base.semanticActivation.maintenance.resolve"] = Control("POST", "/control/semantic-activations/maintenance/resolve", HPDBaseEndpointOperation.SemanticActivationMaintenanceResolve, HPDBaseCapabilities.SemanticActivationMaintenance),
