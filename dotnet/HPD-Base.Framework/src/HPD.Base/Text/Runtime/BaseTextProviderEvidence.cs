...
public static class BaseTextProviderEvidence
{
    ...
    public static BaseTextCompletenessEvidence CreateCompleteness(BaseTextProviderDescriptor provider, BaseTextAuthoritySnapshot snapshot, BaseTextLoweringReceipt lowering, ImmutableArray<BaseTextCandidate> candidates, int takePlusOne)
    {
