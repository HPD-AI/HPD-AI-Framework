...
internal sealed class InMemoryFileStorageProvider : IFileStorageProvider
{
    ...
    public InMemoryFileStorageProvider(IOptions<HPDBaseInMemoryFileStoreOptions> options)
    {
