...
```bash
dotnet publish './dotnet/shared/test/HPD-RealtimeMedia/HPD.Media.AotSmoke.App/HPD.Media.AotSmoke.App.csproj' --framework net10.0 -c Release -r osx-arm64 /p:PublishAot=true --nologo -m:1 2>&1 | awk 'tolower($0) !~ /warning/ { print }'; exit ${pipestatus[1]}
```
