...
internal sealed record GatewayClientRequestBodyV1(string Presence, string? SchemaRef, int? MaximumUtf8Bytes, ImmutableArray<string> MediaTypes);
    ...
    private static GatewayClientGenerationManifestV1 ProjectFromManagedLedger(string securityScheme)
    {
        ...
        foreach (GatewayAdminEndpointDescriptor endpoint in GatewayAdminEndpointLedger.V1.OrderBy(x => x.Operation, StringComparer.Ordinal))
        {
            ...
            operations.Add(new(endpoint.Operation, "HpdGatewayAdmin." + endpoint.Operation, endpoint.Method,
                ...
                Kebab(semantic.DesiredPrecondition), semantic.ProtectedNotFound, Kebab(semantic.MutationResponse),
                ...
                new(Kebab(semantic.RequestBodyPresence), requestRef, semantic.MaximumRequestBodyUtf8Bytes,
