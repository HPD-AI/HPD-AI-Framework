...
internal enum GatewayAdminClientStringBrand : byte
{
    ...
    CandidateId, ActivationIntentId, ContinuationToken, DesiredStateToken, IdempotencyKey, CorrelationId,
}
    ...
    internal void Validate()
    {
        ...
        switch (Brand)
        {
            ...
            case GatewayAdminClientStringBrand.ContinuationToken when
                Name is not ("cursor" or "intentCursor" or "outcomeCursor") || Required ||
...
internal static class GatewayAdminClientParameterProfiles
{
    ...
    private static GatewayAdminClientParameterConstraint Continuation(string name = "cursor") =>
        P(GatewayAdminClientParameterLocation.Query, name, false, GatewayAdminClientStringBrand.ContinuationToken, Cursor);
    ...
    internal static ImmutableArray<GatewayAdminClientParameterConstraint> TargetActivationPage { get; } =
        [Namespace(), Target(), Maximum(), Continuation("intentCursor"), Continuation("outcomeCursor"), Correlation()];
