...
public enum GatewayStatusPreparationState : byte { NotPrepared, Materialized }
...
public sealed record GatewayCondition(
    ...
    ulong ObservedSnapshotSequence);
...
public partial class GatewayStatusJsonContext : JsonSerializerContext;
