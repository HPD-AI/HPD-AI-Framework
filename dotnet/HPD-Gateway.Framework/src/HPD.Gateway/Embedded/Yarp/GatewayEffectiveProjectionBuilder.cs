    ...
    PublicationCandidateIdentity identity)
{
    ...
    {
        internal PreparedProjection(GatewayPreparedProjectionSnapshot snapshot, ImmutableArray<RouteConfig> routes, object preparationKey)
        {
        ...
        internal GatewayPreparedProjectionSnapshot Snapshot { get; }
    ...
    internal PreparedProjection Build(ImmutableArray<RouteConfig> routes)
    {
        ...
        return new PreparedProjection(
            new GatewayPreparedProjectionSnapshot(SchemaVersion, _identity.CandidateId, _identity.ContentHash, records, false),
            routes,
            PreparationKey);
    }
...
internal sealed record GatewayPreparedProjectionSnapshot(
