...
public class SlackSocketModeServiceTests
{
    ...
    /// <summary>
    /// A fake <see cref="SlackBot"/> that records every <see cref="HandleSocketEnvelopeAsync"/> call.
    /// </summary>
    ...
    /// </summary>
    private sealed class RecordingSendService : BotWebSocketService
    {
        public List<string> AcksSent { get; } = new();
        public List<string> CallOrder { get; } = new();
        private readonly RecordingBot _adapter;

        public RecordingSendService(RecordingBot adapter)
