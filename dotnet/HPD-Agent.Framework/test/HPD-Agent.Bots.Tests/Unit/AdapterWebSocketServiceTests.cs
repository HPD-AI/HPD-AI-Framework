...
/// <summary>
/// Tests for <see cref="BotWebSocketService"/> — the reconnect loop, backoff math,
...
/// </summary>
public class BotWebSocketServiceTests
{
    // ── Test double ────────────────────────────────────────────────────────────

    private sealed class TestWebSocketService : BotWebSocketService
    {
    ...
    /// </summary>
    private sealed class ControlledBackoffService : BotWebSocketService
    {
    ...
    public void DefaultBackoff_ReturnsNullAtAttempt12()
    {
        ...
        var method = typeof(BotWebSocketService)
