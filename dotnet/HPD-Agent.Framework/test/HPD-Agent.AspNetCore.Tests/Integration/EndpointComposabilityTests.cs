...
public class EndpointComposabilityTests
{
    ...
    {
        public Task<AgentServiceResult<AgentRespondResult>> AnswerRequestAsync(string agentId, string sessionId, string threadId, IAgentResponseEvent response, CancellationToken cancellationToken = default) => throw new NotSupportedException();
    }

    private sealed class UnsupportedStreamingService : IAgentStreamingService
    {
        public Task<AgentServiceResult<ThreadEventObservationLease>> ObserveThreadEventsAsync(string agentId, ThreadKey anchor, AgentEventHierarchy hierarchy = AgentEventHierarchy.ExactThread, CancellationToken cancellationToken = default) => throw new NotSupportedException();
        ...
        public Task<AgentServiceResult<InputSubmissionDto>> SubmitSubAgentInputAsync(string controllerAgentId, string controllerSessionId, string controllerThreadId, SubAgentLocalId localId, string childAgentId, string childSessionId, string childThreadId, AgentInputEvent input, CancellationToken cancellationToken = default) => throw new NotSupportedException();
