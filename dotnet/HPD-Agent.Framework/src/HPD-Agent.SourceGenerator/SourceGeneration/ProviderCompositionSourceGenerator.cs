...
public sealed class ProviderCompositionSourceGenerator : IIncrementalGenerator
{
    ...
    public void Initialize(IncrementalGeneratorInitializationContext context)
    {
        ...
        context.RegisterSourceOutput(manifests, static (context, manifests) =>
        {
            ...
            source.AppendLine("}");
            source.AppendLine();
            source.AppendLine("/// <summary>Registers the generated composition with the implicit provider host at module load.</summary>");
            source.AppendLine("internal static class ProviderCompositionRegistration");
            source.AppendLine("{");
            source.AppendLine("#pragma warning disable CA2255");
            source.AppendLine("    [ModuleInitializer]");
            source.AppendLine("    internal static void RegisterProviders()");
            source.AppendLine("#pragma warning restore CA2255");
            source.AppendLine("    {");
            source.AppendLine("        global::HPD.Agent.Providers.ProviderCompositionHost.Register(GeneratedProviderComposition.Composition);");
            source.AppendLine("    }");
            source.AppendLine("}");
