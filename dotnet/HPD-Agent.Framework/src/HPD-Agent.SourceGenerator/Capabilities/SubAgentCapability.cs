...
internal class SubAgentCapability : BaseCapability
{
    ...
    public override string GenerateRegistrationCode(object parent)
    {
        ...
        sb.AppendLine("        {");
        sb.AppendLine("            var schemaJson = subAgentDef.InvocationModePolicy == global::HPD.Agent.AgentInvocationModePolicy.ModelChoice");
        sb.AppendLine("                ? \"{\\\"type\\\":\\\"object\\\",\\\"properties\\\":{\\\"taskName\\\":{\\\"type\\\":\\\"string\\\",\\\"description\\\":\\\"A short name used to identify this delegated task and its child thread.\\\"},\\\"input\\\":{\\\"type\\\":\\\"string\\\",\\\"description\\\":\\\"The user's question or task for the sub-agent. Pass the full request here.\\\"},\\\"invocationMode\\\":{\\\"type\\\":[\\\"string\\\",\\\"null\\\"],\\\"description\\\":\\\"Whether to wait for the result now or run in the background. Use synchronous unless the task can continue independently.\\\"}},\\\"required\\\":[\\\"taskName\\\",\\\"input\\\"],\\\"additionalProperties\\\":false}\"");
        sb.AppendLine("                : \"{\\\"type\\\":\\\"object\\\",\\\"properties\\\":{\\\"taskName\\\":{\\\"type\\\":\\\"string\\\",\\\"description\\\":\\\"A short name used to identify this delegated task and its child thread.\\\"},\\\"input\\\":{\\\"type\\\":\\\"string\\\",\\\"description\\\":\\\"The user's question or task for the sub-agent. Pass the full request here.\\\"}},\\\"required\\\":[\\\"taskName\\\",\\\"input\\\"],\\\"additionalProperties\\\":false}\";");
        sb.AppendLine("            using var schemaDocument = global::System.Text.Json.JsonDocument.Parse(schemaJson);");
        sb.AppendLine("            var schema = schemaDocument.RootElement.Clone();");
