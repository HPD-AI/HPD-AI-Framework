...
internal static class OpenApiDiagnostics
{
    ...
    /// ISecretResolver and other dependencies must be injected via the toolharness constructor.
    /// </summary>
    public static readonly DiagnosticDescriptor MethodMustBeParameterless = new(
        ...
        description: "Methods marked with [OpenApi] must be parameterless. " +
                    "Dependencies like ISecretResolver should be declared as constructor parameters on the toolharness class. " +
