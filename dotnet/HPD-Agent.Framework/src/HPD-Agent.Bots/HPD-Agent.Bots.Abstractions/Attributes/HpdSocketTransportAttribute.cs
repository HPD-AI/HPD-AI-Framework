...
/// to the generated AddXxxBot() extension method.
/// </summary>
/// <param name="serviceType">
/// The BackgroundService type to register. Must extend <see cref="BotWebSocketService"/>.
...
{
    /// <summary>The BackgroundService type to register (must extend BotWebSocketService).</summary>
