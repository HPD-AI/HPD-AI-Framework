...
/// <summary>
/// Shared error parser for providers that expose OpenAI-compatible HTTP errors.
/// </summary>
public sealed class OpenAICompatibleErrorHandler : IProviderErrorHandler
{
    public OpenAICompatibleErrorHandler(string providerName)
    {
    ...
    private static ErrorCategory ClassifyError(int? statusCode, string message, string? errorCode)
    {
        ...
        {
            400 or 422 when IsContextWindowMessage(message) => ErrorCategory.ContextWindow,
            401 or 403 => ErrorCategory.AuthError,
            404 => ErrorCategory.ModelNotFound,
            408 or 504 => ErrorCategory.Transient,
            429 when IsQuotaMessage(message) => ErrorCategory.RateLimitTerminal,
    ...
    private static bool IsContextWindowMessage(string message)
