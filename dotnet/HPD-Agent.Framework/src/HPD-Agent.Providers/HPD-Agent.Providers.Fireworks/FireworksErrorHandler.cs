...
internal class FireworksErrorHandler : IProviderErrorHandler
{
    ...
    private static ErrorCategory ClassifyError(int? statusCode, string message, string? errorCode)
    {
        ...
        if (!string.IsNullOrWhiteSpace(errorCode))
        {
            ...
            if (errorCode.Contains("rate", StringComparison.OrdinalIgnoreCase) ||
                errorCode.Contains("too_many_requests", StringComparison.OrdinalIgnoreCase))
                return ErrorCategory.RateLimitRetryable;

            if (errorCode.Contains("quota", StringComparison.OrdinalIgnoreCase) ||
                errorCode.Contains("billing", StringComparison.OrdinalIgnoreCase))
