...
if proof['enabled'] is not False: raise SystemExit('test-conformance-proof must fail closed')
if len(proof['prerequisites'])!=3: raise SystemExit('activation prerequisites drift')
