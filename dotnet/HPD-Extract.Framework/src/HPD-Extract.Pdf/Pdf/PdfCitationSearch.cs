namespace HPD.Extract.Pdf
{
    public sealed class PdfCitationSearch
    {
        ...
        private static HPD.Extract.Models.BoundingBox Union(IReadOnlyList<PdfTextItem> items)
        {
            ...
            return new HPD.Extract.Models.BoundingBox(left, top, right - left, bottom - top);
        }
    }
}
