...
var textExtractRoot = Path.Combine(repoRoot, "dotnet", "HPD-Extract.Framework", "src", "HPD-Extract");
...
Console.WriteLine("==========================================");
Console.WriteLine(" HPD Extract PDF Corpus Baseline ");
Console.WriteLine("==========================================");
...
{
    FormatVersion = 1,
    Engine = "HPD.Extract.Pdf.PdfExtractionEngine",
    Backend = "PDFium",
