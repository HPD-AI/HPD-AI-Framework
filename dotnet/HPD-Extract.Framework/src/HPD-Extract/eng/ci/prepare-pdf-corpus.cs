...
Console.WriteLine("=====================================");
Console.WriteLine(" HPD Extract PDF Corpus Prep ");
Console.WriteLine("=====================================");
...
if (!Directory.Exists(referenceRoot))
{
    throw new DirectoryNotFoundException(
        $"Reference root does not exist: {referenceRoot}. Pass --reference-root or set HPD_EXTRACT_REFERENCE_ROOT.");
}
...
{
    var environmentRoot = Environment.GetEnvironmentVariable("HPD_EXTRACT_REFERENCE_ROOT");
    ...
    bool AllowMissing)
{
    ...
    private static void PrintUsage()
    {
        ...
        Console.WriteLine("  --reference-root: HPD_EXTRACT_REFERENCE_ROOT, sibling HPD-Agent-InternalDocs path, or ~/Desktop/HPD-Agent-InternalDocs/HPD-Extraction/Reference");
        Console.WriteLine("  --output: HPD-Extract.Pdf.Tests/Content/Fixtures/PdfCorpus");
    }
}
