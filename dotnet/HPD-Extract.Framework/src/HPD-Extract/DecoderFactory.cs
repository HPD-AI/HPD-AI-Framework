...
namespace HPD.Extract
{
    ...
    public class DecoderFactory : IDecoderFactory
    {
        ...
        private void RegisterDefaultDecoders(ILoggerFactory? loggerFactory)
        {
            ...
            // PDF
            var pdfDecoder = new PdfDecoder(loggerFactory: loggerFactory);
    ...
    public static class DecoderServiceExtensions
    {
        public static IServiceCollection AddTextExtraction(this IServiceCollection services)
        {
            ...
            services.AddSingleton<IPdfPageSelector, DefaultPdfPageSelector>();
            services.AddSingleton<IPdfPageQualityAnalyzer, DefaultPdfPageQualityAnalyzer>();
            services.AddSingleton<IPdfLayoutProjector, DefaultPdfLayoutProjector>();
            services.AddSingleton<IPdfOcrExecutor, NoOpPdfOcrExecutor>();
            services.AddSingleton<IPdfOcrTextMerger, DefaultPdfOcrTextMerger>();
            services.AddSingleton<IPdfExtractionEngine, PdfExtractionEngine>();
